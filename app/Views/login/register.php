...
<body class="bg-gradient-primary">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-10 col-lg-12 col-md-9">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="p-5">
                                    ...
                                    <?php endif ?>
                                    <!-- <form class="user" action="/login/register" method="Post"> -->
                                    <?php echo form_open('Login/save_register'); ?>
                                    <div class="form-group">
                                        <input type="username" class="form-control form-control-user" id="exampleInputEmail" placeholder="User Name" name="username">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user" id="exampleInputEmail" placeholder="Re Password" name="repassword">
                                    </div>
